...
val q11_1 = oldest([]) = NONE;
val q11_2 = oldest([(1999,12,31)]) = SOME (1999,12,31);
val q11_3 = oldest([(1999,12,31),(2000,1,1)]) = SOME (1999,12,31);
val q11_4 = oldest([(2000,1,1),(1999,12,31)]) = SOME (1999,12,31);
val q11_5 = oldest([(1999,1,1),(2000,1,1),(2001,1,1)]) = SOME (1999,1,1);
val q11_6 = oldest([(2000,1,1),(2001,1,1),(1999,1,1)]) = SOME (1999,1,1);
